---
title: Rolling and Static Forward PE Bands
author: Coconut Martin
date: '2019-02-21'
slug: rolling-and-static-forward-pe-bands
categories:
  - charting
tags:
  - R
...
per1 <- read.csv("C:/Users/Emille.PSC/Google Drive/7. Datasets/all shares forward per 1bf.csv", na.strings = c("", "NA")) %>% mutate(Date = dmy(Date))
per2 <- read.csv("C:/Users/Emille.PSC/Google Drive/7. Datasets/all shares forward per 2bf.csv", na.strings = c("", "NA")) %>% mutate(Date = dmy(Date))
